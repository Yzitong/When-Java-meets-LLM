1. Transformer为何使用[多头注意力机制](https://zhida.zhihu.com/search?content_id=121167399&content_type=Article&match_order=1&q=多头注意力机制&zhida_source=entity)？（为什么不使用一个头）
